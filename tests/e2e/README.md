...
If you don't already have an environment ready, you can set one up by following [these instructions](https://github.com/sc-source/wordpress-develop/blob/master/README.md).
