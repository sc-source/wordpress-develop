 ...
 * into (https://github.com/sc-source/wordpress-develop/commit/36fe58a8c64dcc83fc21bddd5fcf054aef4efb27)[36fe58a].
 *
...
function linkToSha( sha ) {
	const repoName =
		process.env.GITHUB_REPOSITORY || 'sc-source/wordpress-develop';
